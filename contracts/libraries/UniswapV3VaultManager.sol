...
/**
 * @title   Vault Manager
 * @notice  Rebalancing manager for UniswapV3 Vault that maintains the two
 ...
 *          fees.
 */
contract UniswapV3VaultManager is IVaultManager {
    using SafeMath for uint256;

    UniswapV3Vault public immutable vault;
    ...
    /**
     * @param _vault Underlying UniswapV3  Vault
    ...
    constructor(
        ...
        IUniswapV3Pool _pool = UniswapV3Vault(_vault).pool();
        int24 _tickSpacing = _pool.tickSpacing();

        vault = UniswapV3Vault(_vault);
        pool = _pool;
