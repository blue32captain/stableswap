    ...
    ReentrancyGuard
{
    ...
    /**
     * @dev After deploying, manager needs to be set via `setManager()`
    ...
    /**
     * @notice Updates vault's positions. Can only be called by the manager.
    ...
    /**
     * @notice Used to set the manager contract that determines the position
